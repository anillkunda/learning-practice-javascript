...
// Argument: It's the actual value that is passed to the function when calling it. These values are assigned to the function's parameters.
...
// --- Objects in JavaScript are data structures that store a collection of key-value pairs.
